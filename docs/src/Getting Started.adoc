...
== To use them you will have to boot the board in DFU Mode(see above) and For Windows only you will also need the STM Virtual Comport driver (So the board will show up as a DFU device) 
AND DfuSe USB device firmware upgrade STMicroelectronics extension (to actually send the .dfu file to the board)
http://www.st.com/content/st_com/en/products/development-tools/software-development-tools/stm32-software-development-tools/stm32-utilities/stsw-stm32102.html
https://www.st.com/en/development-tools/stsw-stm32080.html
